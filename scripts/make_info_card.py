...
# ===========================================================================
HOST = "PrateekG93"   # shown as  you@github  in the header
...
ROWS = [
    ...
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, TypeScript, Tailwind, UI/UX"),
    ("kv", "Backend", "Node.js, Python, FastAPI, MongoDB"),
    ("kv", "AI / ML", "PyTorch, LLMs (Claude/OpenAI), RAG"),
    ("kv", "DevOps", "Docker, Git, CI/CD, Agile"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "AI Outreach Agent with LangGraph & Docker"),
    ("bul", "BeFluent: AI speaking evaluator (React, FastAPI, Llama 3)"),
    ("bul", "SyncIT: Fine-tuned LatentSync with PyTorch & LoRA"),
]
